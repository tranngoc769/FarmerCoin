                            ...
                            <div class="product-short-description">
                                <table>
                                    <tbody>
                                        ...
                                        <tr style="height: 21px;">
                                            <td style="width: 30%"><a style="width: 100%" href="<?=$keywords['messenger'] ?>" class="single_add_to_cart_button button alt">Tư vấn</a></td>
                                            <td style="width: 118px;"><a id="muangay" href="tel:<?=$keywords['hotline'] ?>" class="single_add_to_cart_button button alt">Mua ngay</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
