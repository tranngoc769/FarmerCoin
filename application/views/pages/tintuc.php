			<main class="page-main" id="page-main">
					...
					<div class="page-main__content">
						<div class="main-content">
								...
								<article>
									<ul id="" class="tab__header">
											<li><a <?php if ($type == "news") : ?> class="active"<?php endif; ?> href="/index.php/blog?type=news">Tin tức</a></li>
											<li><a <?php if ($type != "news") : ?> class="active"<?php endif; ?>  href="/index.php/blog?type=event">Sự kiện</a></li>
									</ul>
									<div class="posts__list" id="posts__list">
											<ul>
												<?php foreach ($first_page as $i => $news) : ?>
													<li><a href="/index.php/blog/detail?id=<?= $news->id ?>" title="<?= $news->title ?>"  ><span class="posts__post-cate">Tin tức</span><span class="posts__post-title"><?= $news->title ?></span><span class="posts__post-date"><?= $news->date ?></span></a></li>
                        <?php endforeach; ?>
											</ul>
									</div>
									<input type="hidden" id='itemTotal' value="<?= $total?>" >
									<input type="hidden" id='itemPerPage' value="<?= $perpage?>" >
									<input type="hidden" id='currentSection' value="<?= $type?>" >
									<input type="hidden" id='shortUri' value="/index.php/blog/loadnews" >
