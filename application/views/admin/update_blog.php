        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Sự kiện / Tin tức</h4>
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <select id="post_type" class="form-control" required>
                                            <option value="event" <?php if ($blog->post_type == "event"): ?> selected <?php endif;?>> Sự kiện</option>
                                            <option value="news" <?php if ($blog->post_type == "news"): ?> selected <?php endif;?>>Tin tức</option>
                                    </select>
                                </div>
                            </div>
                        </div>
