...
class Admin extends CI_Controller
{
    ...
    public function blog_update()
    {
        ...
        $is_sale = $this->input->post("post_type");
        $detail = $this->input->post("detail");
        $up = array("title" => $title, "detail" => $detail, "post_type" => $is_sale, "date" => date('Y-m-d H:i:s'));
    ...
    public function blog_add()
    {
        ...
        $detail = $this->input->post("detail");
        $is_sale = $this->input->post("post_type");
        $up = array("avatar" => "", "title" => $title, "post_type" => $is_sale, "detail" => $detail, "date" => date('Y-m-d H:i:s'));
